...
import com.example.tugas6.databinding.TrendingBinding;
...
public class Trending extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding =TrendingBinding.inflate(getLayoutInflater());
    ...
    private void insertData() {
        binding.btnSubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (rec != null) {
                    Toast.makeText(Trending.this, "Data Inserted", Toast.LENGTH_SHORT).show();
                    binding.edtname.setText("");
                    binding.edtimage.setImageResource(R.mipmap.ic_launcher);
                    binding.edtstar.setText("");
                    binding.edtprice.setText("");
                } else {
                    Toast.makeText(Trending.this, "Something Wrong", Toast.LENGTH_SHORT).show();
                }
            }
        });
//for view display
        binding.btnDisplay.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(Trending.this, DisplayData.class));
            }
        });
//for storing new data or update data
        binding.btnEdit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (recedit != -1) {
                    Toast.makeText(Trending.this, "Update Succesfully", Toast.LENGTH_SHORT).show();
...
//edit hide and submit visible
                    ...
                    Intent a = new Intent(Trending.this, DisplayData.class);
                    startActivity(a);
                }
            }
        });
